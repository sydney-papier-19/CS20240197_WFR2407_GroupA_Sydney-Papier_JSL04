...
const userPreference = 'Sugar-free'; // Possible values: 'Regular', 'Sugar-free', or undefined

const favouriteEnergyDrink = (userPreference === 'Sugar-free') ? "Sugar-free" || "Regular" : "undefined";
console.log(favouriteEnergyDrink);
...
// console.log(``);
const cans = 3;
const cansLeft = (cans <= 5)? "Time to restock!" : "We're stocked!";
console.log(cansLeft);
...
const heartRate = 95; // Current heart rate in bpm
...
const currentTemp = 4; // Current temperature in °C

const drinkTemperature = (currentTemp <= 5) ? "Chilled to perfection." : "Needs a cooler!";
...
const drinkTime = (currentHour >= 7 && currentHour <24) ? "Unleash the beast!":"Better stick to water.";
